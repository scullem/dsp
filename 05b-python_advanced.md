...
>> There are three titles. Each is listed with its frequency below:
...
>> The following is a list containing the faculty email addresses: ['bellamys@mail.med.upenn.edu',
 'warren@upenn.edu',
 'bryanma@upenn.edu',
 'jinboche@upenn.edu',
 'sellenbe@upenn.edu',
...
>> There are four unique email domains. The following is a set containing those four: {'cceb.med.upenn.edu', 'email.chop.edu', 'mail.med.upenn.edu', 'upenn.edu'}
